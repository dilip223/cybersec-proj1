...
#difference is high between raw and virtual data
        ...
        temp_mess.append(['The match found with the existing signature database were = ', matches])
        message_files.append(temp_mess)
    print message_files

    @app.route('/')
    def homepage():
        return render_template("static_analysis.html", num=file_no, nam=name_files, dat=date_files, sec=sec_files, imp=entry_files
